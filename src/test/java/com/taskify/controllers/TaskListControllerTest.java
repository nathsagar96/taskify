...
class TaskListControllerTest {
    ...
    void shouldCreateNewTaskListSuccessfully() throws Exception {
        ...
        TaskListDto createdTaskListDto =
                new TaskListDto(UUID.randomUUID(), request.title(), request.description(), 0, 0.0, java.util.List.of());

        when(taskListService.createTaskList(any(CreateTaskListRequest.class))).thenReturn(createdTaskListDto);
    ...
    void shouldUpdateExistingTaskListSuccessfully() throws Exception {
        ...
        TaskListDto updatedTaskListDto =
                new TaskListDto(taskList1.getId(), request.title(), request.description(), 0, 0.0, java.util.List.of());
    ...
    @Test
    @DisplayName("PUT /api/v1/task-lists/{id} - Should return 404 if task list not found when updating")
    ...
    void shouldDeleteTaskListSuccessfully() throws Exception {
        ...
        mockMvc.perform(delete("/api/v1/task-lists/{id}", taskList1.getId())).andExpect(status().isNoContent());
