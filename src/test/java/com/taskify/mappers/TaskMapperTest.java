...
@DisplayName("TaskMapper - Mapping Tests")
class TaskMapperTest {
    ...
    @Nested
    @DisplayName("Task Entity to DTO Mapping")
    class TaskEntityToDtoMapping {
        @Test
    ...
    @Nested
    @DisplayName("CreateTaskRequest to Task Entity Mapping")
    class CreateTaskRequestToTaskEntityMapping {
        @Test
    ...
    @Nested
    @DisplayName("UpdateTaskRequest to Task Entity Mapping")
    class UpdateTaskRequestToTaskEntityMapping {
        @Test
