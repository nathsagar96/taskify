...
public class TaskController {
    ...
    public ResponseEntity<TaskDto> createTask(
            @PathVariable("task_list_id") UUID taskListId, @Valid @RequestBody CreateTaskRequest request) {
    ...
    public ResponseEntity<TaskDto> updateTask(
        ...
        return ResponseEntity.status(HttpStatus.OK).body(taskService.updateTask(taskListId, id, request));
    }
